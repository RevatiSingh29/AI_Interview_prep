...
export const API_PATHS = {
  ...
  AI: {
    GENERATE_QUESTIONS: "/api/ai/generate_questions",     // Generate interview questions and answers using Gemini
    GENERATE_EXPLANATION: "/api/ai/generate_explanation", // Generate concept explanation using Gemini
  },
